...
var SessaoController = /** @class */ (function () {
    function SessaoController() {
    }
    SessaoController.prototype.Autenticacao = function (request, response) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        token = jsonwebtoken_1.default.sign({ id: usuario.id }, process.env.APP_SECRET, { expiresIn: '30m' });
